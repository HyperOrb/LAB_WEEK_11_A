...
dependencies {
    ...
    implementation("androidx.activity:activity-compose:1.8.2") // Added activity-compose
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.7.0") // Added lifecycle-viewmodel-compose
